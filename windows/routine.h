 ...
 * Version: $Id$
 */
#ifndef _INCLUDE_SOURCEMOD_ROUTINE_DEATH_STATUS_H_
#define _INCLUDE_SOURCEMOD_ROUTINE_DEATH_STATUS_H_
#include "extension.h"
void r_nowAlive(const Vector& position, death_info_t *data, size_t size);
