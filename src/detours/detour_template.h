...
template <typename TDetour, typename TChild, typename TParent>
class DetourTemplate : public TParent {
private:
	...
	{
		static TDetour trampoline = nullptr;
		return trampoline;
	}
...
protected: //note: virtuals should be implemented by the TChild class
