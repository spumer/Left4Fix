...
class RevivedByDefib;

typedef int (RevivedByDefib::*RevivedByDefibFunc)(CBaseEntity*, void*);

class RevivedByDefib: public DetourTemplate<RevivedByDefibFunc, RevivedByDefib>
{
private: //note: implementation of DetourTemplate abstracts

	int OnRevived(CBaseEntity *, void*);

	// get the signature name (i.e. "GetCrouchTopSpeed") from the game conf
	virtual const char *GetSignatureName()
	{
		return "CTerrorPlayer_OnRevivedByDefibrillator";
	}

	//notify our patch system which function should be used as the detour
	virtual RevivedByDefibFunc GetDetour()
	{
		return &RevivedByDefib::OnRevived;
	}
};
